...
class Course {
  ...
  Course(this.courseId, this.name, this.description, this.difficulty,
      this.artworkUrl, this.contributors, this.domains);
  ...
  Course.fromJson(Map<String, dynamic> json)
      : courseId = json['id'] as String,
        ...
        domains = [] {
          final domainData = json['relationships']['domains']['data'] as List<dynamic>;
          if (domainData.isNotEmpty) {
            for (var i=0; i < domainData.length; i++) {
              final domain = Course.getDomain(json['relationships']['domains']['data'][i]['id'] as String);
              domains.add(domain);
            }
          }
        }
